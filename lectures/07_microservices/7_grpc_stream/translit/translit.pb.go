...
const file_translit_proto_rawDesc = "" +
	"\n" +
	"\x0etranslit.proto\x12\btranslit\"\x1a\n" +
	"\x04Word\x12\x12\n" +
	"\x04Word\x18\x01 \x01(\tR\x04Word2?\n" +
	"\x0fTransliteration\x12,\n" +
	"\x04EnRu\x12\x0e.translit.Word\x1a\x0e.translit.Word\"\x00(\x010\x01B\rZ\v./;translitb\x06proto3"

var (
	file_translit_proto_rawDescOnce sync.Once
	file_translit_proto_rawDescData []byte
)

func file_translit_proto_rawDescGZIP() []byte {
	file_translit_proto_rawDescOnce.Do(func() {
		file_translit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_translit_proto_rawDesc), len(file_translit_proto_rawDesc)))
	})
	return file_translit_proto_rawDescData
}

var file_translit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_translit_proto_goTypes = []any{
...
func file_translit_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_translit_proto_rawDesc), len(file_translit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
